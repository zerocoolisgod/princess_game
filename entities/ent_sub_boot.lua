...
local p = Class('sub_boot', Entity)

function p:initialize (x,y)
  Entity.initialize(self,x,y,8,8,"sub boot")
  self.group = 'pickup'
  self.heal = 25
  self.solid = true
  self.spd = 30
  self.sprite = Sprite:new("sub boot",'pickup_sheet',16,16,0,0)
  self.sprite:add_animation('idle',{17},1000)
